...
function init() {
    ...
    const nextBtn = slider.querySelector(".slider .nav1 .next");
    const prevBtn = slider.querySelector(".slider .nav1 .prev");
    ...
    items.forEach((item)=>{
        const textWrapper = item.querySelector(".wrap1");
        textWrapper.innerHTML = textWrapper.textContent.replace(/\S/g, "<span class='letter'>$&</span>");
    });
    function anim(current, next, callback) {
        ...
        tl.add({
            ...
            /*clipPath: ['polygon(0 0, 100% 0, 100% 100%, 0% 100%)', 'polygon(0 100%, 100% 100%, 100% 100%, 0% 100%)'],*/ opacity: [
                1,
                0
            ],
            easing: "easeInQuint",
            ...
            /*clipPath: ['polygon(0 0, 100% 0, 100% 0, 0 0)','polygon(0 0, 100% 0, 100% 100%, 0% 100%)'],*/ opacity: [
                0,
                1
            ],
            easing: "easeOutQuint",
...
},{}]},["9ZIyz","adjPd"], "adjPd", "parcelRequireb9e7")
